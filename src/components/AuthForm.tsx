...
const AuthForm = () => {
  ...
  return (<>
  <h1 className="h1 mb-9 text-brand">Sign In</h1>
     <button
        onClick={() => signIn("google", { callbackUrl: "/" })}
           className="p-3 text-white rounded-full flex border space-x-4 items-center cursor-pointer hover:bg-light-400"
    >
      <svg
      ...
      <p className="text-dark-200 pr-2 text-sm font-medium">
